...
export default function AttendeeDetailScreen() {
  ...
  const optInNetworking = (params.optInNetworking as string) || '';

  const showContact = optInNetworking === 'YES';
          ...
          <View style={[styles.section, { backgroundColor: cardBg }]}>
            {title ? (
              <View style={styles.detailRow}>
                <IconSymbol ios_icon_name="briefcase.fill" android_material_icon_name="work" size={20} color={colors.primary} />
            ...
            {company ? (
              <View style={styles.detailRow}>
                <IconSymbol ios_icon_name="building.2.fill" android_material_icon_name="business" size={20} color={colors.primary} />
                <View style={styles.detailTextContainer}>
            ...
            {showContact && phone ? (
              <View style={[styles.detailRow, { marginBottom: 0 }]}>
                ...
                <View style={styles.detailTextContainer}>
                  ...
                  <Text style={[styles.detailValue, { color: textColor }]}>{phone}</Text>
                </View>
              </View>
            ) : null}
          </View>

          {/* Action buttons — only if opted in */}
...
const styles = StyleSheet.create({
  ...
  attendeeName: { fontSize: 24, fontWeight: 'bold', textAlign: 'center' },
  section: {
    marginHorizontal: 16,
    marginTop: 16,
    padding: 16,
  ...
  actionsSection: { flexDirection: 'row', marginHorizontal: 16, marginTop: 16, gap: 12 },
  actionButton: {
    flex: 1,
    alignItems: 'center',
    paddingVertical: 16,
  ...
  actionButtonText: { fontSize: 14, fontWeight: '600', marginTop: 8 },
});